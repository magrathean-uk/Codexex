...
final class CodexPopoverSizingTests: XCTestCase {
    ...
    func testGlassTokensMatchCompactMenuBarReferenceDesign() {
        ...
        XCTAssertEqual(GlassTokens.pagePadding, 10)
        XCTAssertEqual(GlassTokens.contentSpacing, 8)
        XCTAssertEqual(GlassTokens.cardPadding, 12)
        ...
        XCTAssertEqual(GlassTokens.quotaHeadlineSize, 29)
        XCTAssertEqual(GlassTokens.quotaBarHeight, 7)
        XCTAssertEqual(GlassTokens.limitCardMinHeight, 72)
        XCTAssertEqual(GlassTokens.historyGraphHeight, 58)
