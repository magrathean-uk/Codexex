...
enum GlassTokens {
    ...
    static let popupFooterReservedHeight: CGFloat = 80
    ...
    static let infoChipRadius: CGFloat = 10
    ...
    static let barGlowRadius: CGFloat = 0
    static let shimmerDuration: Double = 0
    static let quotaBarFillDuration: Double = 0
    static let cardInnerGlowOpacity: Double = 0
    static let popupShadowRadius: CGFloat = 0
    static let popupShadowYOffset: CGFloat = 0
    static let ambientBlobBlurRadius: CGFloat = 0
    static let ambientAccentOpacity: Double = 0
    static let cardHoverLift: CGFloat = 0
    static let cardHoverScale: CGFloat = 1
    static let cardHoverAnimationDuration: Double = 0
    static let cardRevealOffset: CGFloat = 0
    static let cardRevealStagger: Double = 0
    static let summaryIconPulseScale: CGFloat = 1
    static let summaryIconPulseDuration: Double = 0
    static let summaryWaveDriftOffset: CGFloat = 0
    static let summaryWaveDriftDuration: Double = 0
    static let historyGraphDrawDuration: Double = 0
    static let refreshSpinDuration: Double = 0.85
}
#endif
